...
> Este anexo resume los vestigios/evidencias mencionadas en [la parte 1](investigacion.md). Cuando un campo (MAC/size/hash del fichero) no está documentado explícitamente, se marca como **N/D**.
>

### A.1 Tabla de evidencias

| ID | Vestigio | Ruta de localización (soporte original) | Contenido mostrado (extracto) | MAC time | Tamaño lógico | Hash del fichero |
|---|---|---|---|---|---:|---|
| E‑001 | Imagen forense (contenedor) | **N/D** (nombre/ruta del fichero de imagen no indicada) | Hashes de referencia y calculados (ver Sección 3) | N/D | N/D | MD5/SHA‑1/SHA‑256 (Sección 3) |
| E‑002 | Hive SAM (usuario `richard`) | `C:\Windows\System32\config\SAM` | Usuario `richard`, 16 logins, último login 2023‑02‑22 14:55:18 | N/D | N/D | N/D |
| E‑003 | Hive SYSTEM (USB history) | `C:\Windows\System32\config\SYSTEM` | IDs y timestamps de USB (Kingston/ROOT_HUB30/VirtualBox) | N/D | N/D | N/D |
| E‑004 | Autoarranque Opera (Run key) | `HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Run` | Entrada de inicio automático de Opera | N/D | N/D | N/D |
| E‑005 | Historial Opera (navegación) | **N/D** (ruta exacta del perfil Opera no documentada) | Accesos a YouTube, Mundo Deportivo, Drive, Vueling/Booking/Edreams | N/D | N/D | N/D |
| E‑006 | Correos Thunderbird (MBOX) | **N/D** (ruta exacta del perfil Thunderbird no documentada) | Enlace Drive, BTC, contraseña `pa$$word @|`, negociación con “Tom” | N/D | N/D | N/D |
| E‑007 | Descarga sospechosa | `C:\Users\Richard\Downloads\pulseaudio-1.1.zip` | ZIP “pulseaudio‑1.1” (aplicación/paquete) | A: 2023‑02‑22 22:46:04; D: 2023‑02‑22 22:46:40; C/M: N/D | N/D | N/D |
| E‑008 | Carpeta relacionada Ubuntu | `C:\Users\Richard\Ubuntu` | Carpeta “Ubuntu” creada/modificada el 22/02/2023 | N/D | N/D | N/D |

### A.2 Evidencia visual asociada (capturas)

- Integridad/hashes: `AF/Proyecto3/img/image-8.png`
- Usuario/logins: `AF/Proyecto3/img/image-1.png`, `AF/Proyecto3/img/image-3.png`, `AF/Proyecto3/img/image.png`
- Equipo/SO: `AF/Proyecto3/img/image-2.png`
- USB: `AF/Proyecto3/img/image-4.png`
- Navegación: `AF/Proyecto3/img/image-5.png`, `AF/Proyecto3/img/image-6.png`
- Viaje: `AF/Proyecto3/img/image-7.png`
- Opera/autoarranque: `AF/Proyecto3/img/image-9.png`, `AF/Proyecto3/img/image-11.png`
- Exfiltración correo: `AF/Proyecto3/img/image-10.png`
